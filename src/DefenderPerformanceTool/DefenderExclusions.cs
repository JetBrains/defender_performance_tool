...
/// <summary>
/// UI helpers for adding Microsoft Defender exclusions, with confirmation. Shared by the
...
public static class DefenderExclusions
{
    ...
    {
        var message = $"Add this {kindLabel} to the Microsoft Defender exclusion list?\n\n{target}\n\n";
